...
static void usage() {
  std::cout << "Gebruik: wled-screen-streamer [opties]\n"
    "  --host HOST             WLED-host (default wled-matrix2.local)\n"
    "  --source screen|rtsp    Videobron (default screen)\n"
    "  --url URL               RTSP-URL (vereist voor source rtsp)\n"
    "  --rtsp-transport tcp|udp (default tcp)\n"
    "  --width N --height N    Matrixafmetingen (default 64x64)\n"
    "  --fps N                 Doel-FPS; 0 = uncapped\n"
    "  --monitor N             XRandR-monitorindex (default 0)\n"
    "  --crop X,Y,W,H          Capturegebied; overschrijft --monitor\n"
    "  --crop-mode full|center-square|center-native (default full)\n"
    "  --crop-x N --crop-y N   Handmatige center-square positie\n"
    "  --crop-size N           Handmatige vierkante cropgrootte\n"
    "  --filter nearest|bilinear\n"
    "  --aa off|gaussian|supersample (default supersample)\n"
    "  --aa-strength FLOAT     Gaussian sigma 0.5..2.0 (default 1.0)\n"
    "  --supersample N         Supersamplefactor (default 2)\n"
    "  --saturation FLOAT      Kleurverzadiging (default 1.15)\n"
    "  --contrast FLOAT        Contrast rond middenniveau (default 1.10)\n"
    "  --brightness FLOAT      Helderheidsfactor (default 1.00)\n"
    "  --gamma FLOAT           Streamergamma (default 1.00 = uit)\n"
    "  --no-color-correction   Schakel alle kleurcorrectie uit\n"
    "  --test-pattern rood|groen|blauw|solid-blue|checkerboard|lijn\n"
    "  --ddp-debug             Print de 9 DDP-headers van het eerste frame\n"
    "  --benchmark             Toon timing/CPU-statistieken per seconde\n"
    "  --help\n";
}
